...
@objc
public enum MyPinViewStyle : Int {
    case none = 0
    case underline
    case box
}
...
public class MyPinView: UIView {
    ...
    fileprivate var reuseIdentifier = "MyPinCell"
    ...
    public var style:MyPinViewStyle = .underline
    ...
    private func loadView() {
        let podBundle = Bundle(for: MyPinView.self)
        let nib = UINib(nibName: "MyPinView", bundle: podBundle)
        view = nib.instantiate(withOwner: self, options: nil)[0] as? UIView
        
        // for CollectionView
        let collectionViewNib = UINib(nibName: "MyPinCell", bundle:podBundle)
    ...
    @objc fileprivate func textFieldDidChange(_ textField: UITextField) {
        ...
        print("NextTag = \(nextTag), index = \(index)")
...
//        } else {
//            // Not found, so dismiss keyboard
//            if index == 4 && shouldDismissKeyboardOnEmptyFirstField {
//
//                textField.resignFirstResponder()
//            } else if index < 4 {
//
...
//        }
        ...
        print("Index = \(index), passwordIndex = \(passwordIndex)")
        print("password = \(password), count = \(password.count)")
    ...
    public func getPin() -> String {
        ...
        print("passwordCount = \(password.count)")
    ...
    public func pastePin(pin:String) {
        ...
        for (index,char) in pin.enumerated() {
            ...
            let textField = collectionView.cellForItem(at: IndexPath(item: index, section: 0))?.viewWithTag(101 + index) as! MyPinField
...
extension MyPinView : UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout
{
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let textField = cell.viewWithTag(100) as! MyPinField
...
extension MyPinView : UITextFieldDelegate
{
